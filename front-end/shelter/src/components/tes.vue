<template>
    <v-parallax src="@/assets/spaniel-background.jpg" style=" width: 100vw; height: 100vh;">
      <v-row style="width: 100vw; background-color: rgb(255, 255, 255, 0);">
        ...
        <div class="title" style="padding: 5px; margin: 0 auto; color: rgb(255, 255, 255); "> Menu  <div style="display: inline-block; font-size: small; margin-bottom: auto; ">  <UserInfo/> </div> </div>
      ...
      <v-tabs
        ...
        class="text cards"
      >
        <v-tab value="one" class="cards">Podopieczni</v-tab>
        <v-tab value="two" class="cards">Adopcje</v-tab>
        <v-tab value="three" class="cards">Konto</v-tab>
      </v-tabs>
      <div
                ...
                <UserForm />
                    ...
                    <v-btn elevation="8" class="text">
                        ...
                        <v-btn elevation="8" class="text">
                          ...
                          Zmień Język</v-btn>
                        <v-divider vertical :thickness="10" class="border-opacity-0"></v-divider>
                        <v-btn elevation="8" class="text"> <v-icon color="rgb(143, 83, 122)"
